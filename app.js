...
try 
{
  ...
  // This code is used to include the HTML code from newsfeed-component.html into the current HTML file
//   fetch("./components/newsfeed-component.html")
//     .then((response) => response.text())
//     .then((data) => {
//       const newsFeedComponent = document.getElementById("newsfeed-container");
